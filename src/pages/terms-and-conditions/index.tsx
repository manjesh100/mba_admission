...
const TermsAndConditionsPage = () => {
    const [activeItem, setActiveItem] = useState<string>("Legal Terms and Conditions");
    ...
    const privacyList = [
        {
            _id: "001",
            privacy_title: "Legal Terms and Conditions"
        },
        {
            _id: "002",
            ...
            <div className="container_width px-5">
                <div className="faq_section">
                    ...
                    <div className="faq_right">
                        <div className="legal_privacy_heading">Legal Terms and Conditions</div>
                    </div>
                </div>
                <div className="faq_section">
